...
class BoardTest {
    ...
    void getPlayers(){
        ...
        Property cellOne = new Property("cellOne", "Colour", 0, 0, 0, 0, 0,
                0, 0, 0, playerOne, 0, 0, false);
        Property cellTwo = new Property("cellTwo", "Colour", 0, 0, 0, 0, 0,
                0, 0, 0, playerOne, 0, 0, false);
        ...
        Board board = new Board(players, cells, propertyData);
    ...
    void getCells(){
        ...
        List<Cell> expected = Arrays.asList(new Property("cellOne", "Colour", 0, 0, 0, 0, 0,
                0, 0, 0, playerOne, 0, 0, false), new Property("cellTwo", "Colour", 0, 0, 0, 0, 0,
                0, 0, 0, playerOne, 0, 0, false));
        assert actual == expected;
    }
    ...
    void getProperties(){
        ...
        Object[][] propertyData = {{"propertyOne", "Colour", 0, 0, 0, 0, 0, 0, 0, 0, playerOne, 0, 0, false},
                {"propertyTwo", "Colour", 0, 0, 0, 0, 0, 0, 0, 0, playerTwo, 0, 0, false}};
        Board board = new Board(players, cells, propertyData);
        Property[] actual = board.getProperties();
        Property[] expected = new Property[2];
        expected[0] = new Property("propertyOne", "Colour", 0, 0, 0, 0, 0,
                0, 0, 0, playerOne, 0, 0, false);
        expected[1] = new Property("propertyTwo", "Colour", 0, 0, 0, 0, 0,
                0, 0, 0, playerOne, 0, 0, false);
        assert actual == expected;
    }
    ...
    void getPlayerCell(){
        ...
        List<Cell> expected = Arrays.asList(new Property("cellOne", "Colour", 0, 0, 0, 0, 0,
                0, 0, 0, playerOne, 0, 0, false),
                new Property("cellTwo", "Colour", 0, 0, 0, 0, 0,
                0, 0, 0, playerOne, 0, 0, false));
        assert actual == expected;
    }
